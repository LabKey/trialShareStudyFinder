...
public class TrialShareStudyDocumentProvider implements SearchService.DocumentProvider
{
    private static final Logger _logger = LoggerFactory.getLogger(TrialShareStudyDocumentProvider.class);
    ...
    {
        TrialShareStudyDocumentProvider dp = new TrialShareStudyDocumentProvider();
