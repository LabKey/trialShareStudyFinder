        ...
        '           </tpl>',
            ...
            '<span class="labkey-publication-right">',
                ...
                '<span class="labkey-publication-edit-link">',
                    '<a class="labkey-text-link labkey-goto-link-text" href="{[this.getEditUrl(values.id)]}"><span class="labkey-data-link-text">Edit</span></a>',
                    '<a class="labkey-goto-link-icon" href="{[this.getEditUrl(values.id)]}"><div class="labkey-data-link-icon"></div></a>',
                '</span>',
                '<br>',
                '<tpl if="dataUrl">',
